 ...
 * Framework's `ZipFile.CreateFromDirectory` both write `icons\icon-16.png`
 * with a backslash. The ZIP format specifies `/`, so an archive built that
 * way is, to a conforming reader, one flat directory of oddly-named files.
 * Chrome is a conforming reader.
 */
