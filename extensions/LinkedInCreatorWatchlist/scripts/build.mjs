...
const EXTENSION_NAME = IS_PROD ? 'LinkedIn Creator Watchlist' : 'LinkedIn Creator Watchlist (Dev)';
...
async function writeManifest(backgroundScript, contentScript) {
  const manifest = {
    ...
    description:
      'Watch specific LinkedIn creators and see their best posts in one place — collected as you browse. No account, no cloud, read-only.',
    icons: {
    ...
    action: {
      default_title: 'Open the watchlist panel',
    },
