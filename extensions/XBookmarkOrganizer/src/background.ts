 ...
 * enabled on any x.com/twitter.com tab (search/organize should work
 * everywhere on the site, not only on the Bookmarks page itself — indexing
 * is what's scoped to Bookmarks, per content_scripts.matches in
 * scripts/build.mjs).
 *
