...
const EXTENSION_NAME = IS_PROD ? 'YouTube Comment Digest' : 'YouTube Comment Digest (Dev)';
...
async function writeManifest(backgroundScript, contentScript) {
  const manifest = {
    ...
    description:
      'A sortable, searchable side panel for the YouTube comments already loaded in the page — keyword search, CSV/Markdown export, and a client-side word-frequency digest. No account, no API, no network requests.',
    icons: {
    ...
    action: {
      default_title: 'Open comment digest',
    },
    // Permissions come straight from PRD-31 §6 — nothing broader.
